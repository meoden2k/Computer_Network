...
int main() {
    ...
    //----> COMPILE = 
    // g++ -std=c++17 -I./ -I./asio/include server.cpp -o server.exe -lmswsock  -lws2_32 -lgdi32 -luser32 -lmfplat -lmf -lmfreadwrite -lmfuuid -lshlwapi -lole32 -loleaut32 -static-libgcc -static-libstdc++ "-Wl,-Bstatic" -lstdc++ -lpthread "-Wl,-Bdynamic"
